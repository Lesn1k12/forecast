...
import { trash1, bitcoin, book, calender, card, circle, clothing, comment, dollar, food, freelance, medical, money, piggy, stocks, takeaway, trash, tv, users, yt } from '../Icons';
...
function IncomeItem({
    ...
    const handleDelete = () => {
        console.log(id); // Додайте цей рядок
        deleteItem(id);
      };
